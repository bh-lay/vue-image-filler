	...
	methods: {
		...
		fileChangeHandle: function fileChangeHandle(event) {
			...
			image.onload = function () {
				_this.size.imageWidth = image.width || image.naturalWidth;
				_this.size.imageHeight = image.height || image.naturalHeight;
...
//# sourceMappingURL=vue-image-filler.es.js.map
